...
ScrollReveal().reveal('.home-img, .services-container, .portfolio-box, .timeline, .timeline-item, .contact form, .certificaciones-box, .portfolio-swiper, .logros-swiper, .Experiencia-box, .particulas, .education', { origin: 'bottom' });
